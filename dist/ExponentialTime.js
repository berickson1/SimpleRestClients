...
var DEFAULT_TIME_GROW_FACTOR = 2.7182818284590451;
var DEFAULT_TIME_JITTER = 0.11962656472;
var ExponentialTime = (function () {
    /**
    ...
    function ExponentialTime(_initialTime, _maxTime, _growFactor, _jitterFactor) {
        if (_growFactor === void 0) { _growFactor = DEFAULT_TIME_GROW_FACTOR; }
        if (_jitterFactor === void 0) { _jitterFactor = DEFAULT_TIME_JITTER; }
